      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '800px', maxHeight: '85vh', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', fontSize: '0.92rem', color: '#334155', lineHeight: '1.7' }}>
          ...
          <section>
            ...
            <p>
              Projects follow a structured 5-phase delivery roadmap overseen directly by executive leadership (Founder & CEO <strong>Abhishek Sah</strong>, Co-Founder & CTO <strong>Krishna Sah</strong>, Co-Founder & COO <strong>Rohit Sah</strong>, and Contracts & Operations Director <strong>Shivshankar Sah</strong>):
            </p>
