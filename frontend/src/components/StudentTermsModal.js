      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '800px', maxHeight: '85vh', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', fontSize: '0.92rem', color: '#334155', lineHeight: '1.7' }}>
          ...
          <section>
            ...
            <p>
              Direct mentorship from Abhishek Sah, Krishna Sah, Rohit Sah, and Shivshankar Sah is conducted through scheduled reviews and asynchronous code feedback. Students are expected to maintain professional communication standards at all times.
            </p>
          </section>
