          ...
          <div>
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4rem' }}>
                {/* Physical Location */}
                <div>
                  <span style={{ fontSize: '0.8rem', color: '#94a3b8', fontWeight: '700', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.35rem' }}>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    style={{ fontSize: '0.85rem', color: '#2563eb', fontWeight: '700', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.3rem' }}
                  >
                    View on Google Maps
                  </a>
                </div>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer"
                      style={{ fontSize: '0.85rem', color: '#10b981', fontWeight: '700', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.3rem' }}
                    >
                ...
                {/* Operating Hours */}
                <div>
                  <span style={{ fontSize: '0.8rem', color: '#94a3b8', fontWeight: '700', textTransform: 'uppercase', display: 'block', marginBottom: '0.2rem' }}>
                    Working Hours
                  </span>
