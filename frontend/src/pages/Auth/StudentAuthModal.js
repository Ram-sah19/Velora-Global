...
export default function StudentAuthModal({ initialMode = 'login', onClose, onAuthSuccess }) {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMsg(err.message || 'Student login failed. Please check your credentials.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div style={{ display: 'flex', borderBottom: '2px solid #e2e8f0', marginBottom: '1.5rem' }}>
          <button
            ...
            style={{
              ...
              background: 'none',
              border: 'none',
              borderBottom: authMode === 'login' ? '3px solid #2563eb' : '3px solid transparent',
          ...
          <button
            ...
            style={{
              ...
              background: 'none',
              border: 'none',
              borderBottom: authMode === 'signup' ? '3px solid #2563eb' : '3px solid transparent',
