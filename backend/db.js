...
const initialData = {
  users: [
    {
      ...
      bio: "Founder & CEO of Velora Global. Directing platform architecture and executive vision."
    },
    {
      id: "user-cofounder-1",
      name: "Krishna Sah",
    ...
    },
    {
      ...
      bio: "Contracts and Operations Director overseeing corporate agreements and compliance."
    },
    {
      id: "user-student-1",
      name: "Aarav Sharma",
  ...
  programs: [
    ...
    },
    {
      ...
      deliverables: ["Write comprehensive unit test cases", "Perform automated end-to-end regression testing"],
      openPositions: 15,
      appliedCount: 30,
      status: "Active"
    },
